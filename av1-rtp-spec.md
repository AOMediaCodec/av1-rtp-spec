...
**Note:** values out of the valid range may indicate the frame is from a different coded video sequence, e.g. packet with the new template dependency structure was lost or delayed.
{:.alert .alert-info }
